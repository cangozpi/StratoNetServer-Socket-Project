...
public class Server
{
    ...
    private int dataSocketPort = 5555;//dataSocket's serverSocket's port
    /**
    ...
    private void ListenAndAccept(){
        ...
        try
        {
            ...
            ServerThread st = new ServerThread(s, dataSocket); //handles multithreading of multiple connections on the socket
            st.start();
